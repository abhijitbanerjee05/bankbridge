...
export const signUp = async (userData: SignUpParams): Promise<User | string> => {
    try {
        const signUpRequest = {
...
export const getDummyUser = async (): Promise<User | undefined> => {
    try {
        const response = await axios.get('/dummyUsers');
